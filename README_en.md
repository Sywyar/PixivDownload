...
- Page batch download — scrape all artworks from search, following feed, ranking pages, etc.
...
| `Pixiv 页面批量下载器.user.js`         | Page DOM scraping (search/following/ranking, etc.) |
